...
public class BrowserUtils {
    ...
    /**
     * Checks whether the title is same with the parameter
     *
     * @param title
     * @param timeout
     * @return
   ...
   /* public static void clickWithJS(WebElement element) {
        procountor.utilities.BrowserUtils.waitForVisibility(element,5);
    ...
    /**
     * This method does wait and send text then
     *
     * @param element
     * @param text
     */
    ...
    /*public static void uploadFileByRobot(String filePath) {
        ...
        if (os_name.toLowerCase().contains("mac")) {
            procountor.utilities.BrowserUtils.waitFor(1);
